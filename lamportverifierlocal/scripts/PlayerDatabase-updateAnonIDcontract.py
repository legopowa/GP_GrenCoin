...
from brownie import network, web3, accounts, Wei, LamportBase2, PlayerDatabase, Contract
...
class LamportTest:
    ...
    def can_test_key_functions(self, accs):
        ...
        paddressToBroadcast = '0xF3A99A9a2836a6fcFcEB846161B900B3d1447236' # Validator needing approval
        ...
        _contract.updateAnonIDContractAddressStepOne(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
        ...
        _contract.updateAnonIDContractAddressStepTwo(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
