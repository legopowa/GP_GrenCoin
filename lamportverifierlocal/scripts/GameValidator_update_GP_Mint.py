...
class LamportTest:
    ...
    def can_test_key_functions(self, accs):
        ...
        paddressToBroadcast = '0xB05d57719694A1C073707906b0E13efFa5975504' # Validator needing approval
        ...
        _contract.updateMintContractAddressStepOne(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
        ...
        _contract.updateMintContractAddressStepTwo(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
