...
# Load mnemonics from files
        ...
        # contract.onboardPlayer(address, "anonID1", {'from': brownie_account})
        # contract.registerValidator(address1, {'from': brownie_account})
        # contract.registerValidator(address2, {'from': brownie_account})
        # contract.registerValidator(address3, {'from': brownie_account})
        # user added here                                  ^^^^^^^^^^^^^^^^^^^^
