...
from brownie import network, web3, accounts, Wei, LamportBase2, GameValidator, Contract
...
class LamportTest:
    ...
    def can_test_key_functions(self, accs):
        ...
        with open('contract_GameValidator-coin.txt', 'r') as file:
        ...
        paddressToBroadcast = '0x6b6482502E3af681f49726C88f937D23952e2986' # Validator needing approval
        ...
        _contract.updatePlayerDatabaseAddressStepOne(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
        ...
        _contract.updatePlayerDatabaseAddressStepTwo(
            current_keys.pub,
            sig,
            nextpkh,
            paddressToBroadcast,
