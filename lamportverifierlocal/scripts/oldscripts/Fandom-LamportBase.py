...
class LamportTest:
    ...
    def can_test_key_functions(self, accs):
        ...
        paddressToBroadcast = '0xA527F50706BB1FCaEd6F864afB2e3FCe4943AF68'
        ...
        _contract.revokeActivityContractPermission(
        ...
        ContractPermissionRevoked_filter = _contract.events.ContractPermissionRevoked.createFilter(fromBlock='latest')

        for event in ContractPermissionRevoked_filter.get_all_entries():
