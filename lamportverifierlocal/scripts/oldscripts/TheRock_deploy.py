from brownie import accounts, TheRock # firewallet
...
def main():
    ...
    contract = TheRock.deploy({'from': brownie_account})
    print(f"TheRock deployed: {contract.address}")
    ...
    #contract2 = WhitelistTest.deploy({'from': accounts[0]})
