...
from brownie import web3, network, accounts, Wei, AnonIDContract, Contract
...
class GanpatiAdmin:
    ...
    def __init__(self):
        ...
        print("Initializing Contract address change...")
    ...
    def can_test_key_functions(self, accs):
        ...
        newaddy = Web3.toChecksumAddress('0xfd003CA44BbF4E9fB0b2fF1a33fc2F05A6C2EFF9')
        packed_message = newaddy + nextpkh[2:]
